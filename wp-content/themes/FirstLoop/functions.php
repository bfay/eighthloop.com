...
{ 
    ...
    wp_register_style( 'open-sans', 'http://fonts.googleapis.com/css?family=Open+Sans:300,700');
    // This is the compiled css file from SCSS
    wp_register_style( 'foundation-css', get_template_directory_uri() . '/stylesheets/foundation.css', array(), '3.0', 'all' );
