    ...
    <div class="divine-content">
     ...
     <div class="post-grid"><!-- Post -->
       <h1 class="post-title">Search results (count: <?php echo count($posts); ?>)</h1><br /><br />
       <div class="clear-both"></div>
       <div class="post-text">
        <?php get_search_form(); ?>
        <div class="clear-both"></div><br />
        <span><?php printf( __( 'Here is the list of posts containing "%s":', '' ), '<b>' . get_search_query() . '</b>' ); ?></span>
        <div class="clear-both"></div><br />
      ...
      <?php else: ?>
        <div class="post-text" style="margin-top: 0;"><?php printf( __( '&quot;%s&quot; not found.', '' ), '<b>' . get_search_query() . '</b>' ); ?></div><span></span>
      <?php endif; ?>
     </div>
    </div>    
<?php
