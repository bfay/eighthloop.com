...
// Spark custom version of Timthumn because it sends an Expire header of "now +10 days", which isn't configurable in a separate "timthumb-config.php" file.
// This version is set to send Expire headers of "now +1 year" with a "cache-control" set to 1 year and removed the "must-revalidate".
...
//Browser caching
if(! defined('BROWSER_CACHE_MAX_AGE') ) 	define ('BROWSER_CACHE_MAX_AGE', 26280000);				// Time to cache in the browser
...
class timthumb {
	...
	protected function sendImageHeaders($mimeType, $dataSize){
		...
		if(BROWSER_CACHE_DISABLE){
			...
			header('Expires: ' . gmdate ('D, d M Y H:i:s', strtotime ('now +1 year')) . ' GMT');
		}
		return true;
	}
